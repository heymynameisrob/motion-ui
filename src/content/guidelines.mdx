...
export const components = {h2: Heading2};
...
Contributions are welcome. Edit [this file](https://github.com/heymynameisrob/motion/blob/main/src/content/guidelines.mdx) and submit a pull request.
