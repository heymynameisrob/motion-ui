export function Coin() {
  return (
    <div className="relative size-18 scale-200">
      <div className="absolute size-14 animate-coin transform-3d">
        <div
          className="absolute w-[6px] h-14 bg-amber-500"
          style={{ transform: "translateX(26px) rotateY(90deg)" }}
        />
      </div>
      <div className="absolute size-14 animate-coin transform-3d">
        <div
          className="absolute w-full h-full backface-hidden rounded-[50%] bg-amber-400 border-2 border-amber-500"
          style={{ transform: "translateZ(3px)" }}
        >
          <CoinIcon />
        </div>
        <div
          className="absolute w-full h-full backface-hidden rounded-[50%] bg-amber-500"
...
function CoinIcon() {
  return (
    <svg viewBox="0 0 718 718" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M170 119H548V599H170V119Z" className="fill-amber-500" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
